...
public class HuffmanStringListCodecTest extends DataCompressionUnitTest
{
    ...
    {
        var progress = BroadcastingProgressReporter.createProgressReporter(Listener.nullListener(), "codec");
        _10.forEachInteger(codecNumber ->
        {
            ...
            var test = BroadcastingProgressReporter.createProgressReporter(Listener.nullListener(), "test");
