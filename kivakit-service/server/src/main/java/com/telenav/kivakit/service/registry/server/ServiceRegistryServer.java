...
import com.telenav.kivakit.service.registry.server.internal.lexakai.DiagramServer;
...
public class ServiceRegistryServer extends Server
{
    ...
    private final SwitchParser<Integer> PORT = SwitchParsers
            .integerSwitchParser(this, "first-port", "The first port in the range of ports to be allocated")
            .defaultValue(50_000)
            .optional()
            .build();

    private final SwitchParser<Scope.Type> SCOPE = SwitchParsers
