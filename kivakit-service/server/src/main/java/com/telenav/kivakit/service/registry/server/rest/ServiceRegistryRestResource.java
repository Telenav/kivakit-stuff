        ...
        ResultTrait
{
    ...
    (
            @Parameter(name = "request",
                       ...
                       required = true,
                       schema = @Schema(
                               implementation = DiscoverApplicationsRequest.class)) DiscoverApplicationsRequest request
    )
    {
    ...
    (
            @Parameter(name = "request",
                       ...
                       required = true,
                       schema = @Schema(
                               implementation = DiscoverPortServiceRequest.class)) DiscoverPortServiceRequest request
    )
    {
    ...
    public Response onVersion()
    {
        String output = "KivaKit Service Registry "
                + SettingsRegistry.settingsFor(this).requireSettings(ServiceRegistrySettings.class).version()
                + "\n"
                + "KivaKit "
